...
class AtomWindow extends EventEmitter {
  constructor (atomApplication, fileRecoveryService, settings = {}) {
    ...
    Object.defineProperty(this.browserWindow, 'loadSettingsJSON', {
      get: () => {
        const v = JSON.stringify(Object.assign({userSettings: this.atomApplication.configFile.get()}, this.loadSettings))
        console.log(this.atomApplication.configFile.get())
        return v
      }
    })
